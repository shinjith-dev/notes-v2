...
I'll share a brief walk-through on how I did this; assuming that you have fundamental knowledge on web development and did similar things before.
...
Create a folder named `blogs` and store some files on it. You can see in the terminal that the files your updating are reflected to the website in realtime. For example, create a file `/blogs/first.md` an add some content to it.
...
Now, please do this step on your own as I don't want this blog to be a long boring  chapter. It's pretty simple, upload to github and host it on Netlify. Please refer these blogs if you're not sure on how to do it:
...
- **Integrations > Identity > Netlify Identity - Enable**, click **Enable Identity**
